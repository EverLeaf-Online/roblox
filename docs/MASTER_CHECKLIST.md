...
- [x] Lumenreach start now uses an invisible terrain-grounded SpawnLocation plus a non-colliding Wayfarer arrival rune/stone marker, replacing the visible Roblox-style rectangular spawn pad.
